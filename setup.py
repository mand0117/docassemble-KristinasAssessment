...
setup(name='docassemble.KristinasAssessment',
      version='0.0.1',
      description=('LLAW3301 C1 Assessment'),
      ...
      author='Kristina Mandelos',
      author_email='mand0117@flinders.edu.au',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/KristinasAssessment/', package='docassemble.KristinasAssessment'),
     )
